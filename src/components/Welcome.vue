...
=======
  ...
  @keyframes fall-115 {
    78.903% {
      transform: translate(99.9477vw, 78.903vh) scale(0.4661);
    }
    to {
      transform: translate(96.49085vw, 100vh) scale(0.4661);
    }
  }
  .snow:nth-child(116) {
    opacity: 0.6362;
    transform: translate(7.6201vw, -10px) scale(0.8745);
    animation: fall-116 27s -13s linear infinite;
  }
  @keyframes fall-116 {
    55.758% {
      transform: translate(11.4469vw, 55.758vh) scale(0.8745);
    }
    to {
      transform: translate(9.5335vw, 100vh) scale(0.8745);
    }
  }
  .snow:nth-child(117) {
    opacity: 0.1389;
    transform: translate(35.9287vw, -10px) scale(0.6554);
    animation: fall-117 21s -20s linear infinite;
  }
  @keyframes fall-117 {
    31.282% {
      transform: translate(32.9688vw, 31.282vh) scale(0.6554);
    }
    to {
      transform: translate(34.44875vw, 100vh) scale(0.6554);
    }
  }
  .snow:nth-child(118) {
    opacity: 0.6325;
    transform: translate(99.8585vw, -10px) scale(0.1943);
    animation: fall-118 19s -13s linear infinite;
  }
  @keyframes fall-118 {
    72.85% {
      transform: translate(99.9344vw, 72.85vh) scale(0.1943);
    }
    to {
      transform: translate(99.89645vw, 100vh) scale(0.1943);
    }
  }
  .snow:nth-child(119) {
    opacity: 0.8595;
    transform: translate(47.7041vw, -10px) scale(0.8966);
    animation: fall-119 26s -5s linear infinite;
  }
  @keyframes fall-119 {
    53.152% {
      transform: translate(56.9321vw, 53.152vh) scale(0.8966);
    }
    to {
      transform: translate(52.3181vw, 100vh) scale(0.8966);
    }
  }
  .snow:nth-child(120) {
    opacity: 0.4487;
    transform: translate(85.7799vw, -10px) scale(0.0015);
    animation: fall-120 26s -10s linear infinite;
  }
  @keyframes fall-120 {
    31.224% {
      transform: translate(76.3623vw, 31.224vh) scale(0.0015);
    }
    to {
      transform: translate(81.0711vw, 100vh) scale(0.0015);
    }
  }
  .snow:nth-child(121) {
    opacity: 0.8434;
    transform: translate(66.5871vw, -10px) scale(0.679);
    animation: fall-121 22s -19s linear infinite;
  }
  @keyframes fall-121 {
    73.216% {
      transform: translate(64.0526vw, 73.216vh) scale(0.679);
    }
    to {
      transform: translate(65.31985vw, 100vh) scale(0.679);
    }
  }
  .snow:nth-child(122) {
    opacity: 0.5383;
    transform: translate(68.8626vw, -10px) scale(0.2333);
    animation: fall-122 19s -25s linear infinite;
  }
  @keyframes fall-122 {
    45.055% {
      transform: translate(65.5918vw, 45.055vh) scale(0.2333);
    }
    to {
      transform: translate(67.2272vw, 100vh) scale(0.2333);
    }
  }
  .snow:nth-child(123) {
    opacity: 0.0469;
    transform: translate(77.3492vw, -10px) scale(0.384);
    animation: fall-123 18s -10s linear infinite;
  }
  @keyframes fall-123 {
    43.079% {
      transform: translate(73.6965vw, 43.079vh) scale(0.384);
    }
    to {
      transform: translate(75.52285vw, 100vh) scale(0.384);
    }
  }
  .snow:nth-child(124) {
    opacity: 0.5222;
    transform: translate(92.8988vw, -10px) scale(0.6704);
    animation: fall-124 27s -14s linear infinite;
  }
  @keyframes fall-124 {
    34.166% {
      transform: translate(89.2741vw, 34.166vh) scale(0.6704);
    }
    to {
      transform: translate(91.08645vw, 100vh) scale(0.6704);
    }
  }
  .snow:nth-child(125) {
    opacity: 0.0626;
    transform: translate(9.2147vw, -10px) scale(0.0734);
    animation: fall-125 24s -21s linear infinite;
  }
  @keyframes fall-125 {
    65.898% {
      transform: translate(14.4979vw, 65.898vh) scale(0.0734);
    }
    to {
      transform: translate(11.8563vw, 100vh) scale(0.0734);
    }
  }
  .snow:nth-child(126) {
    opacity: 0.7737;
    transform: translate(43.0364vw, -10px) scale(0.054);
    animation: fall-126 24s -24s linear infinite;
  }
  @keyframes fall-126 {
    76.363% {
      transform: translate(35.5716vw, 76.363vh) scale(0.054);
    }
    to {
      transform: translate(39.304vw, 100vh) scale(0.054);
    }
  }
  .snow:nth-child(127) {
    opacity: 0.1011;
    transform: translate(86.3521vw, -10px) scale(0.4467);
    animation: fall-127 16s -22s linear infinite;
  }
  @keyframes fall-127 {
    47.563% {
      transform: translate(84.4027vw, 47.563vh) scale(0.4467);
    }
    to {
      transform: translate(85.3774vw, 100vh) scale(0.4467);
    }
  }
  .snow:nth-child(128) {
    opacity: 0.0229;
    transform: translate(15.9372vw, -10px) scale(0.4405);
    animation: fall-128 22s -19s linear infinite;
  }
  @keyframes fall-128 {
    74.251% {
      transform: translate(7.6036vw, 74.251vh) scale(0.4405);
    }
    to {
      transform: translate(11.7704vw, 100vh) scale(0.4405);
    }
  }
  .snow:nth-child(129) {
    opacity: 0.5456;
    transform: translate(15.0955vw, -10px) scale(0.1979);
    animation: fall-129 28s -8s linear infinite;
  }
  @keyframes fall-129 {
    34.836% {
      transform: translate(24.6979vw, 34.836vh) scale(0.1979);
    }
    to {
      transform: translate(19.8967vw, 100vh) scale(0.1979);
    }
  }
  .snow:nth-child(130) {
    opacity: 0.8163;
    transform: translate(83.2029vw, -10px) scale(0.8373);
    animation: fall-130 21s -14s linear infinite;
  }
  @keyframes fall-130 {
    77.313% {
      transform: translate(81.6085vw, 77.313vh) scale(0.8373);
    }
    to {
      transform: translate(82.4057vw, 100vh) scale(0.8373);
    }
  }
  .snow:nth-child(131) {
    opacity: 0.399;
    transform: translate(69.865vw, -10px) scale(0.6367);
    animation: fall-131 20s -15s linear infinite;
  }
  @keyframes fall-131 {
    53.835% {
      transform: translate(76.1833vw, 53.835vh) scale(0.6367);
    }
    to {
      transform: translate(73.02415vw, 100vh) scale(0.6367);
    }
  }
  .snow:nth-child(132) {
    opacity: 0.4815;
    transform: translate(21.0073vw, -10px) scale(0.5443);
    animation: fall-132 12s -1s linear infinite;
  }
  @keyframes fall-132 {
    32.86% {
      transform: translate(29.147vw, 32.86vh) scale(0.5443);
    }
    to {
      transform: translate(25.07715vw, 100vh) scale(0.5443);
    }
  }
  .snow:nth-child(133) {
    opacity: 0.7097;
    transform: translate(84.0304vw, -10px) scale(0.2216);
    animation: fall-133 13s -29s linear infinite;
  }
  @keyframes fall-133 {
    73.95% {
      transform: translate(74.7413vw, 73.95vh) scale(0.2216);
    }
    to {
      transform: translate(79.38585vw, 100vh) scale(0.2216);
    }
  }
  .snow:nth-child(134) {
    opacity: 0.8077;
    transform: translate(32.583vw, -10px) scale(0.9369);
    animation: fall-134 20s -6s linear infinite;
  }
  @keyframes fall-134 {
    36.465% {
      transform: translate(29.441vw, 36.465vh) scale(0.9369);
    }
    to {
      transform: translate(31.012vw, 100vh) scale(0.9369);
    }
  }
  .snow:nth-child(135) {
    opacity: 0.2002;
    transform: translate(92.6284vw, -10px) scale(0.0711);
    animation: fall-135 30s -14s linear infinite;
  }
  @keyframes fall-135 {
    72.136% {
      transform: translate(84.9157vw, 72.136vh) scale(0.0711);
    }
    to {
      transform: translate(88.77205vw, 100vh) scale(0.0711);
    }
  }
  .snow:nth-child(136) {
    opacity: 0.6328;
    transform: translate(34.3351vw, -10px) scale(0.7582);
    animation: fall-136 14s -11s linear infinite;
  }
  @keyframes fall-136 {
    76.585% {
      transform: translate(30.6396vw, 76.585vh) scale(0.7582);
    }
    to {
      transform: translate(32.48735vw, 100vh) scale(0.7582);
    }
  }
  .snow:nth-child(137) {
    opacity: 0.2768;
    transform: translate(89.8314vw, -10px) scale(0.7133);
    animation: fall-137 12s -13s linear infinite;
  }
  @keyframes fall-137 {
    32.508% {
      transform: translate(95.4391vw, 32.508vh) scale(0.7133);
    }
    to {
      transform: translate(92.63525vw, 100vh) scale(0.7133);
    }
  }
  .snow:nth-child(138) {
    opacity: 0.7172;
    transform: translate(2.9525vw, -10px) scale(0.1257);
    animation: fall-138 13s -6s linear infinite;
  }
  @keyframes fall-138 {
    30.777% {
      transform: translate(4.9639vw, 30.777vh) scale(0.1257);
    }
    to {
      transform: translate(3.9582vw, 100vh) scale(0.1257);
    }
  }
  .snow:nth-child(139) {
    opacity: 0.054;
    transform: translate(64.0792vw, -10px) scale(0.933);
    animation: fall-139 19s -1s linear infinite;
  }
  @keyframes fall-139 {
    57.354% {
      transform: translate(56.7119vw, 57.354vh) scale(0.933);
    }
    to {
      transform: translate(60.39555vw, 100vh) scale(0.933);
    }
  }
  .snow:nth-child(140) {
    opacity: 0.7983;
    transform: translate(21.8142vw, -10px) scale(0.0703);
    animation: fall-140 29s -26s linear infinite;
  }
  @keyframes fall-140 {
    34.856% {
      transform: translate(27.6801vw, 34.856vh) scale(0.0703);
    }
    to {
      transform: translate(24.74715vw, 100vh) scale(0.0703);
    }
  }
  .snow:nth-child(141) {
    opacity: 0.4165;
    transform: translate(55.5825vw, -10px) scale(0.2899);
    animation: fall-141 21s -19s linear infinite;
  }
  @keyframes fall-141 {
    49.646% {
      transform: translate(55.8994vw, 49.646vh) scale(0.2899);
    }
    to {
      transform: translate(55.74095vw, 100vh) scale(0.2899);
    }
  }
  .snow:nth-child(142) {
    opacity: 0.2129;
    transform: translate(88.4214vw, -10px) scale(0.0655);
    animation: fall-142 27s -27s linear infinite;
  }
  @keyframes fall-142 {
    53.001% {
      transform: translate(80.8446vw, 53.001vh) scale(0.0655);
    }
    to {
      transform: translate(84.633vw, 100vh) scale(0.0655);
    }
  }
  .snow:nth-child(143) {
    opacity: 0.6539;
    transform: translate(5.1628vw, -10px) scale(0.264);
    animation: fall-143 15s -12s linear infinite;
  }
  @keyframes fall-143 {
    71.364% {
      transform: translate(6.7982vw, 71.364vh) scale(0.264);
    }
    to {
      transform: translate(5.9805vw, 100vh) scale(0.264);
    }
  }
  .snow:nth-child(144) {
    opacity: 0.2056;
    transform: translate(50.7468vw, -10px) scale(0.539);
    animation: fall-144 11s -30s linear infinite;
  }
  @keyframes fall-144 {
    57.676% {
      transform: translate(55.231vw, 57.676vh) scale(0.539);
    }
    to {
      transform: translate(52.9889vw, 100vh) scale(0.539);
    }
  }
  .snow:nth-child(145) {
    opacity: 0.2213;
    transform: translate(62.1189vw, -10px) scale(0.8588);
    animation: fall-145 19s -2s linear infinite;
  }
  @keyframes fall-145 {
    55.534% {
      transform: translate(70.5298vw, 55.534vh) scale(0.8588);
    }
    to {
      transform: translate(66.32435vw, 100vh) scale(0.8588);
    }
  }
  .snow:nth-child(146) {
    opacity: 0.444;
    transform: translate(96.5905vw, -10px) scale(0.272);
    animation: fall-146 20s -29s linear infinite;
  }
  @keyframes fall-146 {
    35.904% {
      transform: translate(103.1951vw, 35.904vh) scale(0.272);
    }
    to {
      transform: translate(99.8928vw, 100vh) scale(0.272);
    }
  }
  .snow:nth-child(147) {
    opacity: 0.2808;
    transform: translate(89.5787vw, -10px) scale(0.6079);
    animation: fall-147 23s -19s linear infinite;
  }
  @keyframes fall-147 {
    59.513% {
      transform: translate(97.7666vw, 59.513vh) scale(0.6079);
    }
    to {
      transform: translate(93.67265vw, 100vh) scale(0.6079);
    }
  }
  .snow:nth-child(148) {
    opacity: 0.4693;
    transform: translate(46.1822vw, -10px) scale(0.4249);
    animation: fall-148 17s -16s linear infinite;
  }
  @keyframes fall-148 {
    33.553% {
      transform: translate(40.8107vw, 33.553vh) scale(0.4249);
    }
    to {
      transform: translate(43.49645vw, 100vh) scale(0.4249);
    }
  }
  .snow:nth-child(149) {
    opacity: 0.4734;
    transform: translate(73.8019vw, -10px) scale(0.8321);
    animation: fall-149 23s -28s linear infinite;
  }
  @keyframes fall-149 {
    42.773% {
      transform: translate(77.8087vw, 42.773vh) scale(0.8321);
    }
    to {
      transform: translate(75.8053vw, 100vh) scale(0.8321);
    }
  }
  .snow:nth-child(150) {
    opacity: 0.6502;
    transform: translate(57.4168vw, -10px) scale(0.0634);
    animation: fall-150 11s -29s linear infinite;
  }
  @keyframes fall-150 {
    66.133% {
      transform: translate(50.5795vw, 66.133vh) scale(0.0634);
    }
    to {
      transform: translate(53.99815vw, 100vh) scale(0.0634);
    }
  }
  .snow:nth-child(151) {
    opacity: 0.0346;
    transform: translate(20.3614vw, -10px) scale(0.7391);
    animation: fall-151 25s -23s linear infinite;
  }
  @keyframes fall-151 {
    39.525% {
      transform: translate(17.2042vw, 39.525vh) scale(0.7391);
    }
    to {
      transform: translate(18.7828vw, 100vh) scale(0.7391);
    }
  }
  .snow:nth-child(152) {
    opacity: 0.7188;
    transform: translate(41.2185vw, -10px) scale(0.7774);
    animation: fall-152 24s -9s linear infinite;
  }
  @keyframes fall-152 {
    49.745% {
      transform: translate(45.4545vw, 49.745vh) scale(0.7774);
    }
    to {
      transform: translate(43.3365vw, 100vh) scale(0.7774);
    }
  }
  .snow:nth-child(153) {
    opacity: 0.5919;
    transform: translate(2.0187vw, -10px) scale(0.1556);
    animation: fall-153 30s -9s linear infinite;
  }
  @keyframes fall-153 {
    47.03% {
      transform: translate(6.0643vw, 47.03vh) scale(0.1556);
    }
    to {
      transform: translate(4.0415vw, 100vh) scale(0.1556);
    }
  }
  .snow:nth-child(154) {
    opacity: 0.3893;
    transform: translate(18.0195vw, -10px) scale(0.0249);
    animation: fall-154 25s -29s linear infinite;
  }
  @keyframes fall-154 {
    65.347% {
      transform: translate(24.8153vw, 65.347vh) scale(0.0249);
    }
    to {
      transform: translate(21.4174vw, 100vh) scale(0.0249);
    }
  }
  .snow:nth-child(155) {
    opacity: 0.3;
    transform: translate(38.4633vw, -10px) scale(0.7886);
    animation: fall-155 17s -13s linear infinite;
  }
  @keyframes fall-155 {
    36.901% {
      transform: translate(40.4988vw, 36.901vh) scale(0.7886);
    }
    to {
      transform: translate(39.48105vw, 100vh) scale(0.7886);
    }
  }
  .snow:nth-child(156) {
    opacity: 0.9795;
    transform: translate(73.1279vw, -10px) scale(0.7238);
    animation: fall-156 27s -21s linear infinite;
  }
  @keyframes fall-156 {
    60.693% {
      transform: translate(63.9569vw, 60.693vh) scale(0.7238);
    }
    to {
      transform: translate(68.5424vw, 100vh) scale(0.7238);
    }
  }
  .snow:nth-child(157) {
    opacity: 0.3074;
    transform: translate(33.6594vw, -10px) scale(0.467);
    animation: fall-157 19s -18s linear infinite;
  }
  @keyframes fall-157 {
    49.757% {
      transform: translate(33.6397vw, 49.757vh) scale(0.467);
    }
    to {
      transform: translate(33.64955vw, 100vh) scale(0.467);
    }
  }
  .snow:nth-child(158) {
    opacity: 0.4384;
    transform: translate(42.2341vw, -10px) scale(0.8376);
    animation: fall-158 16s -24s linear infinite;
  }
  @keyframes fall-158 {
    58.353% {
      transform: translate(45.8728vw, 58.353vh) scale(0.8376);
    }
    to {
      transform: translate(44.05345vw, 100vh) scale(0.8376);
    }
  }
  .snow:nth-child(159) {
    opacity: 0.2688;
    transform: translate(76.9216vw, -10px) scale(0.9657);
    animation: fall-159 12s -9s linear infinite;
  }
  @keyframes fall-159 {
    70.737% {
      transform: translate(68.8077vw, 70.737vh) scale(0.9657);
    }
    to {
      transform: translate(72.86465vw, 100vh) scale(0.9657);
    }
  }
  .snow:nth-child(160) {
    opacity: 0.6252;
    transform: translate(87.9073vw, -10px) scale(0.1867);
    animation: fall-160 17s -2s linear infinite;
  }
  @keyframes fall-160 {
    63.786% {
      transform: translate(82.4619vw, 63.786vh) scale(0.1867);
    }
    to {
      transform: translate(85.1846vw, 100vh) scale(0.1867);
    }
  }
  .snow:nth-child(161) {
    opacity: 0.6807;
    transform: translate(84.5278vw, -10px) scale(0.7602);
    animation: fall-161 19s -28s linear infinite;
  }
  @keyframes fall-161 {
    56.71% {
      transform: translate(76.0252vw, 56.71vh) scale(0.7602);
    }
    to {
      transform: translate(80.2765vw, 100vh) scale(0.7602);
    }
  }
  .snow:nth-child(162) {
    opacity: 0.9286;
    transform: translate(70.3413vw, -10px) scale(0.688);
    animation: fall-162 11s -7s linear infinite;
  }
  @keyframes fall-162 {
    74.53% {
      transform: translate(71.6026vw, 74.53vh) scale(0.688);
    }
    to {
      transform: translate(70.97195vw, 100vh) scale(0.688);
    }
  }
  .snow:nth-child(163) {
    opacity: 0.9127;
    transform: translate(5.7331vw, -10px) scale(0.2878);
    animation: fall-163 30s -30s linear infinite;
  }
  @keyframes fall-163 {
    54.849% {
      transform: translate(0.0679vw, 54.849vh) scale(0.2878);
    }
    to {
      transform: translate(2.9005vw, 100vh) scale(0.2878);
    }
  }
  .snow:nth-child(164) {
    opacity: 0.9387;
    transform: translate(22.9119vw, -10px) scale(0.0087);
    animation: fall-164 19s -6s linear infinite;
  }
  @keyframes fall-164 {
    37.2% {
      transform: translate(22.4202vw, 37.2vh) scale(0.0087);
    }
    to {
      transform: translate(22.66605vw, 100vh) scale(0.0087);
    }
  }
  .snow:nth-child(165) {
    opacity: 0.8516;
    transform: translate(64.0633vw, -10px) scale(0.538);
    animation: fall-165 30s -18s linear infinite;
  }
  @keyframes fall-165 {
    70.625% {
      transform: translate(58.6483vw, 70.625vh) scale(0.538);
    }
    to {
      transform: translate(61.3558vw, 100vh) scale(0.538);
    }
  }
  .snow:nth-child(166) {
    opacity: 0.1483;
    transform: translate(39.1519vw, -10px) scale(0.1747);
    animation: fall-166 27s -24s linear infinite;
  }
  @keyframes fall-166 {
    38.217% {
      transform: translate(43.4245vw, 38.217vh) scale(0.1747);
    }
    to {
      transform: translate(41.2882vw, 100vh) scale(0.1747);
    }
  }
  .snow:nth-child(167) {
    opacity: 0.7846;
    transform: translate(10.1718vw, -10px) scale(0.0811);
    animation: fall-167 14s -25s linear infinite;
  }
  @keyframes fall-167 {
    44.649% {
      transform: translate(12.3881vw, 44.649vh) scale(0.0811);
    }
    to {
      transform: translate(11.27995vw, 100vh) scale(0.0811);
    }
  }
  .snow:nth-child(168) {
    opacity: 0.2706;
    transform: translate(34.9223vw, -10px) scale(0.6774);
    animation: fall-168 12s -13s linear infinite;
  }
  @keyframes fall-168 {
    57.979% {
      transform: translate(29.606vw, 57.979vh) scale(0.6774);
    }
    to {
      transform: translate(32.26415vw, 100vh) scale(0.6774);
    }
  }
  .snow:nth-child(169) {
    opacity: 0.0664;
    transform: translate(19.9059vw, -10px) scale(0.001);
    animation: fall-169 10s -20s linear infinite;
  }
  @keyframes fall-169 {
    64.916% {
      transform: translate(22.343vw, 64.916vh) scale(0.001);
    }
    to {
      transform: translate(21.12445vw, 100vh) scale(0.001);
    }
  }
  .snow:nth-child(170) {
    opacity: 0.6548;
    transform: translate(27.4682vw, -10px) scale(0.0664);
    animation: fall-170 11s -26s linear infinite;
  }
  @keyframes fall-170 {
    45.671% {
      transform: translate(17.6201vw, 45.671vh) scale(0.0664);
    }
    to {
      transform: translate(22.54415vw, 100vh) scale(0.0664);
    }
  }
  .snow:nth-child(171) {
    opacity: 0.8092;
    transform: translate(11.6667vw, -10px) scale(0.9473);
    animation: fall-171 22s -10s linear infinite;
  }
  @keyframes fall-171 {
    75.709% {
      transform: translate(18.7187vw, 75.709vh) scale(0.9473);
    }
    to {
      transform: translate(15.1927vw, 100vh) scale(0.9473);
    }
  }
  .snow:nth-child(172) {
    opacity: 0.4804;
    transform: translate(38.3904vw, -10px) scale(0.2498);
    animation: fall-172 19s -18s linear infinite;
  }
  @keyframes fall-172 {
    41.529% {
      transform: translate(41.1356vw, 41.529vh) scale(0.2498);
    }
    to {
      transform: translate(39.763vw, 100vh) scale(0.2498);
    }
  }
  .snow:nth-child(173) {
    opacity: 0.4263;
    transform: translate(18.7513vw, -10px) scale(0.0554);
    animation: fall-173 17s -13s linear infinite;
  }
  @keyframes fall-173 {
    67.254% {
      transform: translate(22.2326vw, 67.254vh) scale(0.0554);
    }
    to {
      transform: translate(20.49195vw, 100vh) scale(0.0554);
    }
  }
  .snow:nth-child(174) {
    opacity: 0.4491;
    transform: translate(18.3127vw, -10px) scale(0.3394);
    animation: fall-174 18s -5s linear infinite;
  }
  @keyframes fall-174 {
    41.716% {
      transform: translate(16.17vw, 41.716vh) scale(0.3394);
    }
    to {
      transform: translate(17.24135vw, 100vh) scale(0.3394);
    }
  }
  .snow:nth-child(175) {
    opacity: 0.5274;
    transform: translate(57.2981vw, -10px) scale(0.9183);
    animation: fall-175 14s -14s linear infinite;
  }
  @keyframes fall-175 {
    36.737% {
      transform: translate(49.8368vw, 36.737vh) scale(0.9183);
    }
    to {
      transform: translate(53.56745vw, 100vh) scale(0.9183);
    }
  }
  .snow:nth-child(176) {
    opacity: 0.0238;
    transform: translate(99.6034vw, -10px) scale(0.4209);
    animation: fall-176 27s -30s linear infinite;
  }
  @keyframes fall-176 {
    49.463% {
      transform: translate(93.6675vw, 49.463vh) scale(0.4209);
    }
    to {
      transform: translate(96.63545vw, 100vh) scale(0.4209);
    }
  }
  .snow:nth-child(177) {
    opacity: 0.959;
    transform: translate(33.9943vw, -10px) scale(0.7203);
    animation: fall-177 24s -13s linear infinite;
  }
  @keyframes fall-177 {
    58.31% {
      transform: translate(37.3802vw, 58.31vh) scale(0.7203);
    }
    to {
      transform: translate(35.68725vw, 100vh) scale(0.7203);
    }
  }
  .snow:nth-child(178) {
    opacity: 0.1077;
    transform: translate(81.5002vw, -10px) scale(0.5669);
    animation: fall-178 18s -22s linear infinite;
  }
  @keyframes fall-178 {
    53.923% {
      transform: translate(89.7509vw, 53.923vh) scale(0.5669);
    }
    to {
      transform: translate(85.62555vw, 100vh) scale(0.5669);
    }
  }
  .snow:nth-child(179) {
    opacity: 0.7974;
    transform: translate(16.1945vw, -10px) scale(0.3583);
    animation: fall-179 12s -23s linear infinite;
  }
  @keyframes fall-179 {
    30.852% {
      transform: translate(13.7185vw, 30.852vh) scale(0.3583);
    }
    to {
      transform: translate(14.9565vw, 100vh) scale(0.3583);
    }
  }
  .snow:nth-child(180) {
    opacity: 0.6796;
    transform: translate(19.6237vw, -10px) scale(0.0148);
    animation: fall-180 20s -24s linear infinite;
  }
  @keyframes fall-180 {
    69.512% {
      transform: translate(22.5269vw, 69.512vh) scale(0.0148);
    }
    to {
      transform: translate(21.0753vw, 100vh) scale(0.0148);
    }
  }
  .snow:nth-child(181) {
    opacity: 0.2505;
    transform: translate(56.1507vw, -10px) scale(0.9634);
    animation: fall-181 12s -29s linear infinite;
  }
  @keyframes fall-181 {
    59.376% {
      transform: translate(63.2374vw, 59.376vh) scale(0.9634);
    }
    to {
      transform: translate(59.69405vw, 100vh) scale(0.9634);
    }
  }
  .snow:nth-child(182) {
    opacity: 0.5273;
    transform: translate(94.2781vw, -10px) scale(0.7551);
    animation: fall-182 12s -1s linear infinite;
  }
  @keyframes fall-182 {
    76.598% {
      transform: translate(94.4196vw, 76.598vh) scale(0.7551);
    }
    to {
      transform: translate(94.34885vw, 100vh) scale(0.7551);
    }
  }
  .snow:nth-child(183) {
    opacity: 0.1784;
    transform: translate(11.8523vw, -10px) scale(0.2425);
    animation: fall-183 12s -4s linear infinite;
  }
  @keyframes fall-183 {
    71.668% {
      transform: translate(19.4388vw, 71.668vh) scale(0.2425);
    }
    to {
      transform: translate(15.64555vw, 100vh) scale(0.2425);
    }
  }
  .snow:nth-child(184) {
    opacity: 0.9701;
    transform: translate(18.1562vw, -10px) scale(0.5818);
    animation: fall-184 25s -14s linear infinite;
  }
  @keyframes fall-184 {
    46.252% {
      transform: translate(20.1282vw, 46.252vh) scale(0.5818);
    }
    to {
      transform: translate(19.1422vw, 100vh) scale(0.5818);
    }
  }
  .snow:nth-child(185) {
    opacity: 0.3369;
    transform: translate(31.5161vw, -10px) scale(0.8279);
    animation: fall-185 22s -6s linear infinite;
  }
  @keyframes fall-185 {
    39.552% {
      transform: translate(26.082vw, 39.552vh) scale(0.8279);
    }
    to {
      transform: translate(28.79905vw, 100vh) scale(0.8279);
    }
  }
  .snow:nth-child(186) {
    opacity: 0.9286;
    transform: translate(47.4528vw, -10px) scale(0.971);
    animation: fall-186 18s -25s linear infinite;
  }
  @keyframes fall-186 {
    58.011% {
      transform: translate(46.356vw, 58.011vh) scale(0.971);
    }
    to {
      transform: translate(46.9044vw, 100vh) scale(0.971);
    }
  }
  .snow:nth-child(187) {
    opacity: 0.6764;
    transform: translate(18.0291vw, -10px) scale(0.616);
    animation: fall-187 27s -23s linear infinite;
  }
  @keyframes fall-187 {
    39.207% {
      transform: translate(25.2488vw, 39.207vh) scale(0.616);
    }
    to {
      transform: translate(21.63895vw, 100vh) scale(0.616);
    }
  }
  .snow:nth-child(188) {
    opacity: 0.741;
    transform: translate(48.2033vw, -10px) scale(0.9032);
    animation: fall-188 15s -11s linear infinite;
  }
  @keyframes fall-188 {
    53.877% {
      transform: translate(49.6114vw, 53.877vh) scale(0.9032);
    }
    to {
      transform: translate(48.90735vw, 100vh) scale(0.9032);
    }
  }
  .snow:nth-child(189) {
    opacity: 0.1925;
    transform: translate(3.8476vw, -10px) scale(0.133);
    animation: fall-189 10s -4s linear infinite;
  }
  @keyframes fall-189 {
    69.849% {
      transform: translate(-2.2164vw, 69.849vh) scale(0.133);
    }
    to {
      transform: translate(0.8156vw, 100vh) scale(0.133);
    }
  }
  .snow:nth-child(190) {
    opacity: 0.6896;
    transform: translate(40.1267vw, -10px) scale(0.4555);
    animation: fall-190 23s -2s linear infinite;
  }
  @keyframes fall-190 {
    77.718% {
      transform: translate(33.0249vw, 77.718vh) scale(0.4555);
    }
    to {
      transform: translate(36.5758vw, 100vh) scale(0.4555);
    }
  }
  .snow:nth-child(191) {
    opacity: 0.7713;
    transform: translate(78.5773vw, -10px) scale(0.0517);
    animation: fall-191 28s -29s linear infinite;
  }
  @keyframes fall-191 {
    65.85% {
      transform: translate(68.8449vw, 65.85vh) scale(0.0517);
    }
    to {
      transform: translate(73.7111vw, 100vh) scale(0.0517);
    }
  }
  .snow:nth-child(192) {
    opacity: 0.5355;
    transform: translate(95.195vw, -10px) scale(0.4396);
    animation: fall-192 10s -30s linear infinite;
  }
  @keyframes fall-192 {
    79.434% {
      transform: translate(98.2106vw, 79.434vh) scale(0.4396);
    }
    to {
      transform: translate(96.7028vw, 100vh) scale(0.4396);
    }
  }
  .snow:nth-child(193) {
    opacity: 0.9708;
    transform: translate(73.8285vw, -10px) scale(0.4952);
    animation: fall-193 24s -5s linear infinite;
  }
  @keyframes fall-193 {
    45.563% {
      transform: translate(69.9687vw, 45.563vh) scale(0.4952);
    }
    to {
      transform: translate(71.8986vw, 100vh) scale(0.4952);
    }
  }
  .snow:nth-child(194) {
    opacity: 0.7596;
    transform: translate(33.2515vw, -10px) scale(0.9634);
    animation: fall-194 16s -17s linear infinite;
  }
  @keyframes fall-194 {
    37.329% {
      transform: translate(24.7009vw, 37.329vh) scale(0.9634);
    }
    to {
      transform: translate(28.9762vw, 100vh) scale(0.9634);
    }
  }
  .snow:nth-child(195) {
    opacity: 0.1247;
    transform: translate(76.1438vw, -10px) scale(0.581);
    animation: fall-195 21s -28s linear infinite;
  }
  @keyframes fall-195 {
    32.985% {
      transform: translate(79.012vw, 32.985vh) scale(0.581);
    }
    to {
      transform: translate(77.5779vw, 100vh) scale(0.581);
    }
  }
  .snow:nth-child(196) {
    opacity: 0.8615;
    transform: translate(8.7194vw, -10px) scale(0.4385);
    animation: fall-196 25s -15s linear infinite;
  }
  @keyframes fall-196 {
    46.121% {
      transform: translate(9.6927vw, 46.121vh) scale(0.4385);
    }
    to {
      transform: translate(9.20605vw, 100vh) scale(0.4385);
    }
  }
  .snow:nth-child(197) {
    opacity: 0.8219;
    transform: translate(10.9387vw, -10px) scale(0.0839);
    animation: fall-197 15s -17s linear infinite;
  }
  @keyframes fall-197 {
    58.616% {
      transform: translate(5.3602vw, 58.616vh) scale(0.0839);
    }
    to {
      transform: translate(8.14945vw, 100vh) scale(0.0839);
    }
  }
  .snow:nth-child(198) {
    opacity: 0.8783;
    transform: translate(68.5313vw, -10px) scale(0.0627);
    animation: fall-198 11s -11s linear infinite;
  }
  @keyframes fall-198 {
    76.024% {
      transform: translate(65.8099vw, 76.024vh) scale(0.0627);
    }
    to {
      transform: translate(67.1706vw, 100vh) scale(0.0627);
    }
  }
  .snow:nth-child(199) {
    opacity: 0.6385;
    transform: translate(87.8721vw, -10px) scale(0.8993);
    animation: fall-199 23s -25s linear infinite;
  }
  @keyframes fall-199 {
    56.314% {
      transform: translate(88.0986vw, 56.314vh) scale(0.8993);
    }
    to {
      transform: translate(87.98535vw, 100vh) scale(0.8993);
    }
  }
  .snow:nth-child(200) {
    opacity: 0.8937;
    transform: translate(51.6002vw, -10px) scale(0.8655);
    animation: fall-200 28s -21s linear infinite;
  }
  @keyframes fall-200 {
    44.149% {
      transform: translate(45.4728vw, 44.149vh) scale(0.8655);
    }
    to {
      transform: translate(48.5365vw, 100vh) scale(0.8655);
    }
  }
>>>>>>> login
</style>
